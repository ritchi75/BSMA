...
public class Memory {
	...
	/**
	 * Returns the size of the smallest chunk that will store a file of the input
	 * size.
	 *
	...
	/**
	 * Returns the index location of the first available chunk of size chunkSize.
	 * If there is no chunk of that size available, the smallest chuck available
	...
	/**
	 * Starts at a specified Memory location and backtracks up the tree structure
	 * merging nodes where possible.
	 *
	 * @param index
	 */
	...
	/**
	 * @return the total amount of available memory that can be used to save Data
	 */
